...
$STD apt-get install -y \
  ...
  python3-dev \
  python3-pip
$STD apt-get install -y ca-certificates &>/dev/null
$STD apt-get install -y gnupg &>/dev/null
UBUNTU_CODENAME=jammy
$STD mkdir -p /etc/apt/keyrings
$STD curl -fsSL "https://keyserver.ubuntu.com/pks/lookup?fingerprint=on&op=get&search=0x6125E2A8C77F2818FB7BD15B93C4A3FD7BB9C367" | gpg --dearmour -o /usr/share/keyrings/ansible-archive-keyring.gpg
